-- ====================================
-- FUNÇÕES ESPECÍFICAS DO SISTEMA DE CHAT (CORRIGIDO)
-- ====================================
...
BEGIN
    ...
    IF p_remetente_tipo = 'funcionario' THEN
        ...
        SET 
            ...
            atendente_id = CASE WHEN atendente_id IS NULL THEN p_remetente_id ELSE atendente_id END,
